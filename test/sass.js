...
describe('sass compiler', function () {
    ...
    describe('middleware', function () {
        ...
        it('should create middleware', function () {
            middleware = devtools.sass(srcRoot, staticRoot, 'css/sass');
        ...
        it('should compile a known sass file without error', function (next) {
            req.path = '/css/sass/app.css';
        ...
        it('should compile a sass file in a nested directory', function (next) {
            req.path = '/css/sass/inc/colors.css';
        ...
        it('should not compile an unavailable sass file', function (next) {
            req.path = '/css/sass/unknown.css';
    ...
    describe('middleware with object config', function () {
        ...
        it('should create middleware', function () {
            middleware = devtools.sass(srcRoot, staticRoot, { dir: 'css/sass' });
            assert.isFunction(middleware);
        });
    ...
    describe('compilation hooks', function () {
        ...
        var req = { method: 'get', path: '/css/sass/app.css' };
        var res = {};
        ...
        describe('precompile', function () {
            ...
            it('should invoke the provided precompile hook', function (next) {
                ...
                middleware = devtools.sass(srcRoot, staticRoot, { dir: 'css/sass', precompile: precompile });
                middleware(req, res, function (err) {
                    assert.ok(!err);
                    assert.ok(invoked);
                    fs.readFile(path.join(staticRoot, req.path), 'utf8', function (err, body) {
        ...
        describe('postcompile', function () {
            ...
            it('should invoke the provided postcompile hook', function (next) {
                ...
                middleware = devtools.sass(srcRoot, staticRoot, { dir: 'css/sass', postcompile: postcompile });
                middleware(req, res, function (err) {
                    assert.ok(!err);
                    assert.ok(invoked);
                    fs.readFile(path.join(staticRoot, req.path), 'utf8', function (err, body) {
        ...
        describe('all', function () {
            ...
            it('should invoke all hooks', function (next) {
                ...
                middleware = devtools.sass(srcRoot, staticRoot, { dir: 'css/sass', precompile: precompile, postcompile: postcompile });
                middleware(req, res, function (err) {
                    assert.ok(!err);
